...
public interface HMap{
    ...
    public interface HEntry {
         ...
         *  @param o true if the specified object is equal to this map entry.
         ...
         *  removed from the backing map (by the iterator's remove operation),
         ...
         *  call is undefined if the mapping has already been removed from
         *  the map (by the iterator's remove operation).
         *  
