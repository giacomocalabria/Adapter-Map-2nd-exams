...
public class TestRunner
{
    ...
    public static void main(String[] args){
        ...
        testResults = JUnitCore.runClasses(TestSuiteMapAdapter.class, TestSuiteCollectionAdapter.class, TestCollection.class, TestSuiteSubKeyEntrySetAdapter.class, TestSuiteSubValuesCollectionAdapter.class);
